...
%        snr    target SNR in dB or power ratio [default: Inf]
...
% it is more efficient to use resample() on the noise signal. After using
% resample you should discard the first and last ceil(10*max(fsx/fsa,1)+1) samples
...
%      Version: $Id: v_addnoise.m 4872 2014-07-18 20:02:58Z dmb $
%
